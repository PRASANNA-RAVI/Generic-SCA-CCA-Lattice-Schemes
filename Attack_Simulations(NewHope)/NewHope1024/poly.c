...
*              - const poly *p:    pointer to input polynomial
**************************************************/
void poly_compress(unsigned char *r, const poly *p, int choice_v1, int choice_v2, int choice_v3, int choice_v4)
{
  ...
  for(i=0;i<NEWHOPE_N;i+=8)
  {
    for(j=0;j<8;j++)
    {
        ...
        else if(i+j == NEWHOPE_N/4)
        {
            t[j] = choice_v2;
        }
        else if(i+j == NEWHOPE_N/2)
        {
            t[j] = choice_v3;
        }
        else if(i+j == 3*NEWHOPE_N/4)
        {
            t[j] = choice_v4;
        }
        else
