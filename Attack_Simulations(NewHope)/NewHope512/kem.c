...
* Returns 0 (success)
**************************************************/
int crypto_kem_enc(unsigned char *ct, unsigned char *ss, const unsigned char *pk, int count, int choice_u, int choice_v_1, int choice_v_2)
{
    ...
    cpapke_enc(ct, buf, pk, k_coins_d + NEWHOPE_SYMBYTES, count, choice_u, choice_v_1, choice_v_2);                                      /* coins are in k_coins_d+NEWHOPE_SYMBYTES */
...
int crypto_kem_dec(unsigned char *ss, const unsigned char *ct, const unsigned char *sk)
{
    ...
    message_oracle = cpapke_dec(buf, ct, sk);
