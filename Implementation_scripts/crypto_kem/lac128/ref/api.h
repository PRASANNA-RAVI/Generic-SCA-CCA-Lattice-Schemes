...
int pke_enc_seed(const unsigned char *pk, const unsigned char *m, unsigned long long mlen, unsigned char *c, unsigned long long *clen, unsigned char *seed, int count, int profiling);
int pke_enc_seed_cmp(const unsigned char *pk, const unsigned char *m, unsigned long long mlen, unsigned char *c, unsigned long long *clen, unsigned char *seed);
// decrypt
...
int crypto_kem_enc( unsigned char *ct, unsigned char *ss, const unsigned char *pk, int count, int profiling);
int crypto_kem_dec( unsigned char *ss, const unsigned char *ct, const unsigned char *sk);

int kem_enc_fo(const unsigned char *pk, unsigned char *k, unsigned char *c, int count, int profiling);
