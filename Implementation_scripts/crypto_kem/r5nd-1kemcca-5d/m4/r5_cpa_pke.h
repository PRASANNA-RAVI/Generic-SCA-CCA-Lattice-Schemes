...
//  CPA encrypt
int r5_cpa_pke_encrypt(uint8_t *ct, const uint8_t *pk, const uint8_t *m, const uint8_t *rho, int count, int profiling);
int r5_cpa_pke_encrypt_cmp(uint8_t *ct, const uint8_t *pk, const uint8_t *m, const uint8_t *rho);
