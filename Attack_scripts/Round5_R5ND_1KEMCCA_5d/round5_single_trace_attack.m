...
threshold = 15;  % choosing appropriate threshold...
leaky_points_no = 0;
...
no_attack_files = 490; % Total number of coefficients...
no_attack_traces = 980; % Five trials for each coefficient (256 * 2)
no_traces_in_file = 2;
